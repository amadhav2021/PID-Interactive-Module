...
const kDInput = document.getElementById('derivGain');
const kIInput = document.getElementById('intGain');
...
function simulationStep() {
    ...
    thrust = kP * error + kI * integralError + kD * derivative;
...
kDInput.addEventListener('change', updateParameters);
kIInput.addEventListener('change', updateParameters);
